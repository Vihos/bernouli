def lobachevsky_method(f, coefficients, iterations, accuracy=0.1 ** 5):
    if iterations > 0:
        ...
        temp_x1 = (coefficients[1] / coefficients[0]) ** (1 / 2 ** iterations)
        temp_x2 = (coefficients[2] / coefficients[1]) ** (1 / 2 ** iterations)
        temp_x3 = (coefficients[3] / coefficients[2]) ** (1 / 2 ** iterations)
